...
def generate_cinematic_video(slug, title_upper, default_data, cache_dir_name):
    ...
    for i, item in enumerate(slides_data):
        ...
        if photo_img:
            ...
            # Clean dark overlay for text readability (no heavy color tint)
        ...
        # Content Box (Match Innovator Quest style)
        bx = 120
...
if __name__ == "__main__":
    jobs = [
        (
            ...
            "OUR VISION", 
            [
                {"title": "CURIOSITY", "desc": "Innovation begins with curiosity.", "photo": "https://images.unsplash.com/photo-1504384764586-bb4cdc1707b0?w=1920&auto=format&fit=crop&q=80", "color": [0, 240, 255]},
                {"title": "LEADERSHIP", "desc": "Develop leadership and transform ideas into solutions.", "photo": "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=1920&auto=format&fit=crop&q=80", "color": [255, 68, 119]},
                {"title": "GROWTH", "desc": "Together, we learn, innovate, and grow.", "photo": "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=1920&auto=format&fit=crop&q=80", "color": [0, 255, 136]}
            ],
            "vision"
        ),
        (
            ...
            "THE FOUNDATION",
            [
                {"title": "STRONG ROOTS", "desc": "Every strong community starts with a solid foundation.", "photo": "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=1920&auto=format&fit=crop&q=80", "color": [183, 108, 253]},
                {"title": "NEW BEGINNINGS", "desc": "The Installation Ceremony marked a new academic journey.", "photo": "https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=1920&auto=format&fit=crop&q=80", "color": [255, 170, 0]}
            ],
            "foundation"
        ),
        (
    ...
    for slug, title, data, cache_name in jobs:
        print(f"\n--- Starting {title} ---")
        generate_cinematic_video(slug, title, data, cache_name)
